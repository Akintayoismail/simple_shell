...
| `_exit` | [man 2 \_exi## List of allowed functions / syscalls
| Functions | Reference |
| --------- | --------- |
| `access` | [man 2 access](https://linux.die.net/man/2/access) |
| `chdir` | [man 2 chdir](https://linux.die.net/man/2/chdir) |
| `close` | [man 2 close](httt](https://linux.die.net/man/2/_exit) |
...
## Authors
* Akintayo Ismail
[Github link](https://github.com/Akintyaoismail)
* Poopedi Chris
[Github link](https://github.com/molokochris)
